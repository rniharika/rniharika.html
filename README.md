  ...
  <body>
    <a-scene>
      ...
      <a-entity position="-3 1 -6" rotation="5 0 0">
        ...
        <a-entity position="-0.5 0.5 -0.5" scale="0.6 1.2 1" text-geometry="value:ARCHANA; font: #exoFont; bevelEnabled: true; bevelSize: 0.1; bevelThickness: 0.1; curveSegments: 1; size: 1.5; height: 0.5;" material="color:pink; metalness:0.9; roughness: 0.05; sphericalEnvMap: #chrome;"></a-entity>
